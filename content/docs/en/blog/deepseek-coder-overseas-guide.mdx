...
4. **Set your base URL** to `https://tokenpapa.ai/v1`
...
Overseas developers can access DeepSeek Coder through [TokenPAPA](https://tokenpapa.ai) using the OpenAI-compatible API at `https://tokenpapa.ai/v1`. No Chinese phone number is needed, US credit cards and PayPal are accepted, and setup takes under 3 minutes. You sign up with just an email address.
