---
title: How to Access DeepSeek API from the US (No Chinese Phone Number Needed)
description: Complete guide to accessing DeepSeek API from the US. Learn how to sign up, get API keys, and start using DeepSeek V3/R1 without a Chinese phone number — with US-friendly pricing and documentation.
---
...
| Multi-model | Support for DeepSeek V3, R1, Coder, and MiniMax |
