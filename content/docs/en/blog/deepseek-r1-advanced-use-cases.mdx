...
Yes. [TokenPAPA](https://tokenpapa.ai) provides access to DeepSeek R1 through an OpenAI-compatible API at `https://tokenpapa.ai/v1`. No Chinese phone number is required. US credit cards are accepted, and setup takes about 3 minutes.
