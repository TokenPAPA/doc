...
description: "3 proven methods to use DeepSeek API without a Chinese phone. Access DeepSeek from the US via relay services, self-hosting, or cloud providers."
...
> 💡 **Pro tip:** Since the API is OpenAI-compatible, you can also use LangChain, LlamaIndex, Vercel AI SDK, and any other OpenAI-compatible framework — just point the `base_url` to `https://tokenpapa.ai/v1`.
