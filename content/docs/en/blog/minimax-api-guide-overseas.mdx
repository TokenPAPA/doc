---
title: "MiniMax API Guide — Setup & Pricing for Overseas Devs"
description: "Complete MiniMax API guide for overseas developers. Pricing tiers, setup steps, Python code examples, and how to access MiniMax without a Chinese phone."
...
4. **Use the provided endpoint** (`https://tokenpapa.ai/v1`) in your code.
