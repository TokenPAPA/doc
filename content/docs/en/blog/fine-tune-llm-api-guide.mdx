...
```json
{
  "messages": [
    ...
    {"role": "assistant", "content": "You can connect to DeepSeek V4 from the US via our unified API endpoint at tokenpapa.ai. No VPN needed."}
  ]
}
```
...
curl https://tokenpapa.ai/v1/fine-tune \
