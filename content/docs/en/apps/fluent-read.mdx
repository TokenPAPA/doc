...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to TokenPAPA for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the TokenPAPA console, you can add
...
### Import Configuration from TokenPAPA Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the TokenPAPA console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the TokenPAPA configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | TokenPAPA                                  |
| Access Token        | TokenPAPA Key                              |
| TokenPAPA Endpoint     | TokenPAPA Deployment Address (without /v1) |
