...
<JsonLd json='{"@context": "https://schema.org", "@type": "Article", "headline": "2026年多提供商LLM策略：回退链、成本优化与冗余架构", "description": "2026年多提供商LLM策略：回退链、成本优化与冗余架构", "datePublished": "2026-06-30", "author": {"@type": "Organization", "name": "TokenPAPA"}, "publisher": {"@type": "Organization", "name": "TokenPAPA"}}' />
...
PROVIDERS = [
    ...
    {"name": "gateway", "base_url": "https://tokenpapa.ai/v1/chat/completions",
