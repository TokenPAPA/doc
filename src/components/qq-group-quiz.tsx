    ...
    questions: [
      {
        ...
        correct: 'b',
        errorMessage:
          'Please re-read the project introduction. TokenPAPA is an open-source AI interface management and distribution system.',
      },
      {
        id: 'q2',
        question:
      ...
      {
        id: 'q3',
        question: '3. Does TokenPAPA have a closed-source paid version?',
        options: [
          {
            value: 'true',
          ...
          },
          {
            value: 'false',
            label:
              'No, TokenPAPA is open-source software, but a commercial license is required in certain scenarios',
          },
        ],
        correct: 'false',
        errorMessage:
          'According to Group Rule 4: TokenPAPA is open-source software, but a commercial license is required in certain scenarios. For details, please see the Project Introduction.',
      },
      {
        id: 'q4',
        question:
    ...
    questions: [
      {
        ...
        correct: 'b',
        errorMessage:
          '请重新阅读项目介绍。TokenPAPA 是一个开源的AI接口管理和分发系统。',
      },
      {
        id: 'q2',
      ...
      {
        id: 'q3',
        question: '3. TokenPAPA 是否有闭源的付费版本？',
        options: [
          { value: 'true', label: '有，存在付费的闭源版本' },
          {
            value: 'false',
            label: '没有，TokenPAPA 采用 AGPLv3 开源协议，遵守协议即可免费使用',
          },
        ],
        correct: 'false',
        errorMessage:
          '根据群规第4条：TokenPAPA 采用 GNU AGPLv3 开源协议，只要遵守开源协议即可免费使用。',
      },
      {
        id: 'q4',
    ...
    questions: [
      {
        ...
        correct: 'b',
        errorMessage:
          'プロジェクト紹介を再度お読みください。TokenPAPAはオープンソースのAIインターフェース管理・配布システムです。',
      },
      {
        id: 'q2',
        question:
      ...
      {
        id: 'q3',
        question: '3. TokenPAPAにはクローズドソースの有料版がありますか？',
        options: [
          { value: 'true', label: 'はい、クローズドソースの有料版があります' },
          {
            value: 'false',
            label:
              'いいえ、TokenPAPAはオープンソースソフトウェアですが、特定のシナリオでは商用ライセンスが必要です',
          },
        ],
        correct: 'false',
        errorMessage:
          'グループルール4により：TokenPAPAはオープンソースソフトウェアですが、特定のシナリオでは商用ライセンスが必要です。詳細については、プロジェクト紹介をご覧ください。',
      },
      {
        id: 'q4',
        question:
