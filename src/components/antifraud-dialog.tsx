...
> = {
  zh: {
    title: '关于打击假冒 TokenPAPA 官方及侵权行为的严正声明',
    sections: [
      {
        heading: '第一：官方绝未公开发售接口，谨防受骗！',
        body: <>TokenPAPA 为纯粹的开源项目，我司<B>从未授权任何机构或个人开展代理或销售</B>。凡在外打着&ldquo;TokenPAPA 官方 / 合作方 / 自营&rdquo;旗号售卖 API 额度或中转服务的，<B>100% 均为假冒李鬼</B>，请广大用户务必擦亮眼睛！</>,
      },
      {
  ...
  en: {
    title: 'Official Statement Against Counterfeit TokenPAPA Services & Infringement',
    sections: [
      {
        heading: 'We have NEVER publicly sold API access — beware of scams!',
        body: <>TokenPAPA is a purely open-source project. We have <B>never authorized any organization or individual to act as an agent or reseller</B>. Anyone selling API quotas or relay services under the name &ldquo;TokenPAPA Official / Partner / Self-operated&rdquo; is <B>100% fraudulent</B>.</>,
      },
      {
  ...
  ja: {
    title: 'TokenPAPA の偽造サービスおよび権利侵害に対する公式声明',
    sections: [
      {
        heading: '公式は API を一切販売していません — 詐欺にご注意ください！',
        body: <>TokenPAPA は純粋なオープンソースプロジェクトです。<B>いかなる機関や個人にも代理販売を許可したことはありません</B>。「TokenPAPA 公式 / パートナー / 自営」を名乗り API クォータや中継サービスを販売するものは、<B>100% 偽物です</B>。</>,
      },
      {
